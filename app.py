...
st.markdown("""
    ...
    .stApp {
        ...
        background-image: linear-gradient(335deg, #050505 23px, transparent 23px), linear-gradient(155deg, #080808 23px, transparent 23px), linear-gradient(335deg, #050505 23px, transparent 23px), linear-gradient(155deg, #080808 23px, transparent 23px);
    ...
    .wall-container { display: flex; flex-wrap: wrap; justify-content: center; align-items: center; gap: 15px; padding: 40px; }
    .graffiti-tag { display: inline-block; padding: 5px 15px; filter: drop-shadow(3px 3px 2px #000); transition: all 0.3s; }
    </style>
...
if messaggi:
    ...
    for m in messaggi:
        tags_html += f"""
            ...
            ">
                {m.get('testo', '')}
                <div style="font-size: 10px; color: rgba(255,255,255,0.2); font-family: sans-serif;">
